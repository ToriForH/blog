<?php
$slider_topic = selectOne('titles', ['visibility' => 1, 'label' => 'carousel_topic'])['title'];
if(isset($slider_topic)) {
...
$slider_title = selectOne('titles', ['visibility' => 1, 'label' => 'carousel_name'])['title'];
?>

<!-- Post Slider -->
<?php if(isset($slider_topic)): ?>
