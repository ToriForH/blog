...
if(isset($_SESSION['id'])) {
    $user_menus = selectAll('navigation', ['user_menu' => 1]);
    foreach ($links as $key => $l) {
        if( $l['name'] == 'Log In' || $l['name'] == 'Sign Up') {
            unset($links[$key]);
        }
    }
}
...
<header>
    <a href="<?php echo BASE_URL . '/index.php' ?>" class="logo">
        ...
        <ul class="nav">
            ...
            <li><a href="<?php echo BASE_URL . $l['link']; ?>"><?php echo $l['name']; ?></a> </li>
            <?php endforeach; ?>
            ...
            <?php if(isset($_SESSION['id'])): ?>
                <li>
                    ...
                    <ul class="us">
                        <?php foreach ($user_menus as $key => $l): ?>
                            <?php if($l['link'] == '/logout.php'): ?>
                                <li><a class="logout" href="<?php echo BASE_URL . $l['link']; ?>"><?php echo $l['name']; ?></a> </li>
                            <?php else: ?>
                                <li><a href="<?php echo BASE_URL . $l['link']; ?>"><?php echo $l['name']; ?></a> </li>
                            <?php endif; ?>
                        <?php endforeach; ?>
